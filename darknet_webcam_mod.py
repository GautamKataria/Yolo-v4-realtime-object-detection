...
def YOLO(in123):
    ...
    while True:
        ...
        #in123 = input("Enter name of output video without extension: ")
        ...
        out = cv2.VideoWriter(                                          # Set the Output path for video writer
            F"./Demo/{in123}.avi", cv2.VideoWriter_fourcc(*"MJPG"), 25.0,
        ...
        while not keyboard.is_pressed('q'):                                                      # Load the input frame and write output frame.
            ...
            cv2.imshow('webcam detections', image)                                    # Display Image window
            cv2.waitKey(3)
...
if __name__ == "__main__":
    in123 = input("Enter name of output video without extension: ")
    YOLO(in123)                                                           # Calls the main function YOLO()
